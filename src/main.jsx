  ...
  return (
    <div className="page home-page">
      <section className="home-hero">
        ...
        <p>{empty ? 'Upload files to a store, then ask a question.' : 'Your second brain is ready — ask it anything.'}</p>
      </section>

      <section className="stat-grid">
        <article role="button" tabIndex={0} onClick={goToStat('hub')} onKeyDown={onStatKeyDown('hub')}>
          <Folder size={16} className="stat-icon" />
          <strong>{stores.length}</strong><span>Stores</span>
        </article>
        <article role="button" tabIndex={0} onClick={goToStat('hub')} onKeyDown={onStatKeyDown('hub')}>
          <FileText size={16} className="stat-icon" />
          <strong>{files.length}</strong><span>Files</span>
        </article>
        <article role="button" tabIndex={0} onClick={goToStat('explore')} onKeyDown={onStatKeyDown('explore')}>
        ...
        <section className="home-panels">
          <div className="panel">
            <div className="panel-head">
              <h2>Recent files</h2>
              <button type="button" className="panel-view-all" onClick={() => onNavigate('hub')}>View all</button>
            </div>
          ...
          <div className="panel">
            <div className="panel-head">
              <h2>Recent chats</h2>
              <button type="button" className="panel-view-all" onClick={() => onNavigate('explore')}>View all</button>
            </div>
